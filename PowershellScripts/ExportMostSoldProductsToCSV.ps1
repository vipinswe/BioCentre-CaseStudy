...
Try
{
	...
	Invoke-Sqlcmd -ServerInstance $SQLInstance -Database $SQLDatabase -Username $SQLUsername -Password $SQLPassword -Query "EXEC dbo.uspGetTop3SoldProductsForQuarter" | Export-Csv $CSVFileName -NoTypeInformation
